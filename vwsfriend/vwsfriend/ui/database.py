...
class TripEditForm(FlaskForm):
    ...
    startDate = DateTimeLocalField('Start Date and Time (UTC)', validators=[DataRequired()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
    endDate = DateTimeLocalField('End Date and Time (UTC)', validators=[DataRequired()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
...
class ChargingSessionEditForm(FlaskForm):
    id = HiddenField('id', validators=[Optional()])
    vehicle_vin = HiddenField('id', validators=[DataRequired()])
    connected = DateTimeLocalField('Plug Connection Date and Time (UTC)', validators=[Optional()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
    locked = DateTimeLocalField('Plug Locked Date and Time (UTC)', validators=[Optional()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
    started = DateTimeLocalField('Charging Start Date and Time (UTC)', validators=[DataRequired()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
    ended = DateTimeLocalField('Charging End Date and Time (UTC)', validators=[Optional()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
    unlocked = DateTimeLocalField('Plug Unlocked Date and Time (UTC)', validators=[Optional()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
    disconnected = DateTimeLocalField('Plug Disconnect Date and Time (UTC)', validators=[Optional()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
...
class RefuelSessionEditForm(FlaskForm):
    id = HiddenField('id', validators=[Optional()])
    vehicle_vin = HiddenField('id', validators=[DataRequired()])
    date = DateTimeLocalField('Date and Time (UTC)', validators=[Optional()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
    startSOC_pct = IntegerField('SoC at start', validators=[Optional(), NumberRange(min=0, max=100)])
    endSOC_pct = IntegerField('SoC at end', validators=[Optional(), NumberRange(min=0, max=100)])
    mileage_km = IntegerField('Mileage in km when charging', validators=[Optional(), NumberRange(min=0)])
    position_latitude = DecimalField('Position Latitude', places=10, validators=[Optional(), NumberRange(min=-90, max=90)])
...
class JourneyEditForm(FlaskForm):
    id = HiddenField('id', validators=[Optional()])
    vehicle_vin = HiddenField('id', validators=[DataRequired()])
    start = DateTimeLocalField('Start date and Time (UTC)', validators=[DataRequired()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
    end = DateTimeLocalField('End date and Time (UTC)', validators=[DataRequired()], format='%Y-%m-%dT%H:%M:%S', render_kw={"step": "1"})
