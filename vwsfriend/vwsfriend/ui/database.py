...
class ChargingSessionEditForm(FlaskForm):
    ...
    charger_id = SelectField("Charger", validators=[Optional()])
    meterStart_kWh = DecimalField('Meter start value (kWh)', places=4, validators=[Optional(), NumberRange(min=0, max=999999)])
    meterEnd_kWh = DecimalField('Meter end value (kWh)', places=4, validators=[Optional(), NumberRange(min=0, max=999999)])
